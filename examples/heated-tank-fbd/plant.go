...
// Plant is the same in-process heated-surge-tank simulation as
// examples/heated-tank, implemented as a nautilus io.Driver: it consumes the
// controller's outputs (pump, heater) and produces the field inputs (level,
// temperature). A real deployment swaps this for a Modbus/OPC-UA/etc. driver
